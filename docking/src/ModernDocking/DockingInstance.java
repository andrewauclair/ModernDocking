...
public class DockingInstance {
     ...
     */
    public void registerDockingPanel(RootDockingPanel panel, JFrame parent) {
     ...
     */
    public void registerDockingPanel(RootDockingPanel panel, JDialog parent) {
        if (rootPanels.containsKey(parent)) {
            throw new DockableRegistrationFailureException("RootDockingPanel already registered for frame: " + parent);
        }
    ...
    public void configurePinning(Window window, int layer, boolean allow) {
        ...
        RootDockingPanel root = DockingComponentUtils.rootForWindow(this, window);
    ...
    public boolean pinningAllowed(Dockable dockable) {
        RootDockingPanel root = DockingComponentUtils.rootForWindow(this, DockingComponentUtils.findWindowForDockable(this, dockable));
    ...
    public void dock(Dockable dockable, Window window, DockingRegion region, double dividerProportion) {
        RootDockingPanel root = rootPanels.get(window);
